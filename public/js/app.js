...
$(document).ready(function () {
    ...
    var modifyProduct = function modifyProduct(id) {
        if (id && id.length > 0) {
            axios.get('/api/product/' + id).then(function (result) {
                console.log(result);
    ...
    var deleteProduct = function deleteProduct(id) {
        ...
        $('#confirmDelete').click(function () {
            if (id.length > 0) {
                axios.delete('/api/product/' + id).then(function (result) {
    ...
    $('#createProduct').on('submit', function (event) {
        ...
        var data = new FormData(document.getElementById('createProduct'));
